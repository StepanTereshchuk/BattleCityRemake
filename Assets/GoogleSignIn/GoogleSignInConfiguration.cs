...
namespace Google {
  ...
  public class GoogleSignInConfiguration {
    ...
    /// </summary>
    /// <remarks>Note: The Games _configuration is not supported on non-Android
    /// platforms.
    /// If games _configuration is used, you must also add the
    ...
    /// <remarks>Required for requesting _auth code or id token.</remarks>
    public string WebClientId = null;
    /// <summary>Set to true for getting an _auth code when authenticating.
    /// </summary>
