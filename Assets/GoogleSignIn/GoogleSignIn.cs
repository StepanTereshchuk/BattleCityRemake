...
namespace Google {
  ...
  /// <para>
  /// <code>
  /// private static readonly GoogleSignInConfiguration _configuration =
  ...
  static GoogleSignIn() {
    ...
    ///<summary> The _configuration settings for Google Sign-in.</summary>
    ///<remarks> The _configuration should be set before calling the sign-in
    /// methods.  Once the _configuration is set it cannot be changed.
    ///</remarks>
    public static GoogleSignInConfiguration Configuration {
      set {
        // Can set the _configuration until the singleton is created.
        if (theInstance == null || theConfiguration == value || theConfiguration == null) {
          ...
          throw new SignInException(GoogleSignInStatusCode.DeveloperError,
              ...
              " Cannot change _configuration after creation.");
        }
      }
    ...
    /// <summary>
    /// Signs out the UserData.
    /// </summary>
    /// <remarks>Future sign-in attempts will require the userData to select the
    ...
    /// </summary>
    /// <remarks>When the userData is disconnected, it revokes all access that may
    /// have been granted to this application.  This includes any server side
    /// access tokens derived from server _auth codes.  As a result, future
    /// sign-in attempts will require the userData to re-consent to the requested
    /// scopes.
    /// </remarks>
